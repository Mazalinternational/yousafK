...
import { RiceWarehouseController } from './rice-warehouse.controller.js';
...
@Module({
  ...
  controllers: [RiceWarehouseController],
  providers: [RiceWarehouseService],
})
export class RiceWarehouseModule {}

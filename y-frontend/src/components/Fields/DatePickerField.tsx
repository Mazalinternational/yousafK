...
type DatePickerFieldPropsTyped<TFieldValues extends FieldValues = FieldValues> =
  {
...
const DatePickerField = <TFieldValues extends FieldValues = FieldValues>({
  name,
  label,
  control,
  required = false,
  disabled = false,
  className,
}: DatePickerFieldPropsTyped<TFieldValues>) => {
